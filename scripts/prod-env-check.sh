...
#   BASE_URL=https://desk.fredheimtech.com ADMIN_TOKEN=… ./scripts/prod-env-check.sh
#
# Env:
#   BASE_URL         deployment origin (default https://desk.fredheimtech.com)
...
BASE_URL="${BASE_URL:-https://desk.fredheimtech.com}"
LIVE="${LIVE:-1}"
