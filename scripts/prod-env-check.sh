...
#   BASE_URL=https://www.fredheimdesk.com ADMIN_TOKEN=… ./scripts/prod-env-check.sh
#
# Env:
#   BASE_URL         deployment origin (default https://www.fredheimdesk.com)
...
BASE_URL="${BASE_URL:-https://www.fredheimdesk.com}"
LIVE="${LIVE:-1}"
